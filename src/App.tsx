...
export default function App() {
  ...
  const savePreferences = (newPrefs: UserPreferences) => {
    newPrefs = { ...newPrefs, letterSpacing: newPrefs.letterSpacing ?? 0.05, wordSpacing: newPrefs.wordSpacing ?? 0.1, bionicReading: newPrefs.bionicReading ?? false, syllableBreaking: newPrefs.syllableBreaking ?? false };
